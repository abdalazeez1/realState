...
mixin _$PageState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AppException<dynamic> exception, String error)
        error,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(AppException<dynamic> exception, String error)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _init<T> implements PageState<T> {
...
abstract class _Lodaing<T> implements PageState<T> {
...
abstract class _Loaded<T> implements PageState<T> {
...
abstract class _Empty<T> implements PageState<T> {
...
abstract class _$$_ErrorCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({AppException<dynamic> exception, String error});
}
...
class _$_Error<T> implements _Error<T> {
  const _$_Error({required this.exception, required this.error});
  ...
  @override
  String toString() {
    return 'PageState<$T>.error(exception: $exception, error: $error)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, exception, error);
  ...
  TResult when<TResult extends Object?>({
    ...
    return error(exception, this.error);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return error?.call(exception, this.error);
  }
...
abstract class _Error<T> implements PageState<T> {
  const factory _Error(
      ...
      required final String error}) = _$_Error<T>;
