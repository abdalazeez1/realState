...
class DioClient with DioMixin implements Dio {
 ...
 String  hendleMessage(dynamic exceptionResponse) => (exceptionResponse is Map && exceptionResponse['message'] != null)? (exceptionResponse['message'] ?? " Some thing happen") : 'Something happen ';//todo click to submit error
}
